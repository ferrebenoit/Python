...
class DocGenerator :
    ...
    def gen_switch_interfaces(self, template, interfaces):
        ...
        for interface in interfaces:
            result = "{}\n{}".format(result, self.gen_switch_interface(interface.groupdict(), template))
    ...
    def gen_switch_page(self, switch_conf, template_str):
        ...
        generated_interfaces = self.gen_switch_interfaces(self.__template_interface, interfaces)
